...
var generateMediaQuery = (function (value, args) {
  ...
  var style = css.apply(void 0, _toConsumableArray(args));

  if (isObject(value)) {
    var obj = getObj(value);
    return css(_templateObject(), obj.querie, obj.size, obj.unit, style);
  } else if (Array.isArray(value)) {
    var query = value.map(function (e) {
      var obj = getObj(e);
      return "(".concat(obj.querie, ": ").concat(obj.size).concat(obj.unit, ")");
    });
    return css(_templateObject2(), query.join(' and '), style);
  } else if (typeof value === 'number') {
    if (value > 0) {
      return css(_templateObject3(), value, style);
    }

    return css(_templateObject4(), style);
  } else if (typeof value === 'string') {
    return css(_templateObject5(), value, style);
  }
...
var index = styled.div(_templateObject$2(), function (props) {
...
var index$1 = styled.div(_templateObject$3(), function (props) {
...
var index$2 = styled.div(_templateObject$4(), function (props) {
  return props.fluid && css(_templateObject2$2(), mediaProperty(props, propsChecker(props, 'gridFluid'), 'padding-left'), mediaProperty(props, propsChecker(props, 'gridFluid'), 'padding-right'));
});

export { index as Col, index$1 as Row, index$2 as Grid, media };
