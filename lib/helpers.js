...
var checkWidth = exports.checkWidth = function checkWidth(params) {
  ...
  return Object.keys(object).map(function (key) {
    if (object[key] === 'auto') {
      // $FlowIssues
      return media[key](_templateObject2);
    }
    ...
    // $FlowIssues
    return media[key](_templateObject3, percent, percent);
  });
};
...
var mediaProperty = exports.mediaProperty = function mediaProperty(params, paramsKey, calculate) {
  ...
  return Object.keys(object).map(function (key) {
    if (calculate) {
      return media[key](_templateObject4, paramsKey, calculate ? calculate(object[key]) : object[key]);
    }

    return media[key](_templateObject5, paramsKey, object[key]);
  });
};