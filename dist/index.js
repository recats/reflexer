...
var media = Object.keys(sizeMedia).reduce(function (accumulator, label) {
  var accum = accumulator;
  accum[label] = function () {
    return css(_templateObject$1, sizeMedia[label], css.apply(undefined, arguments));
  };
  return accum;
}, {});

var checkPercent = function checkPercent(size) {
  return 100 / (12 / size) + '%';
};

var checkWidth = function checkWidth(object) {
...
var mediaProperty = function mediaProperty(object, paramsKey, calculate) {
  return Object.keys(object).map(function (key) {
    if (key === 'xs') {
...
// eslint-disable-next-line
var Col = styled.div(_templateObject$2, function (props) {
  return propsChecker(props, 'colGutter');
}, function (props) {
  return propsChecker(props, 'colGutter');
}, function (props) {
  return props.order && mediaProperty(props.order, 'order');
}, function (props) {
  return props.offset && mediaProperty(props.offset, 'margin-left', checkPercent);
}, function (props) {
  return props.basis && checkWidth(props.basis);
});
...
var FlexCol = function FlexCol(_ref) {
  ...
  return React__default.createElement(Col, {
    basis: basis, order: order, offset: offset, theme: theme
  }, children);
};
...
var Row = styled.div(_templateObject$3, function (props) {
  return propsChecker(props, 'rowGutter');
}, function (props) {
  return propsChecker(props, 'rowGutter');
}, function (props) {
...
var FlexRow = function FlexRow(_ref) {
  var children = _ref.children,
      flexDirection$$1 = _ref.flexDirection,
      flexWrap$$1 = _ref.flexWrap,
      justifyContent$$1 = _ref.justifyContent,
      alignItems$$1 = _ref.alignItems,
      alignContent$$1 = _ref.alignContent,
      theme = _ref.theme;
  return React__default.createElement(Row, {
    flexDirection: flexDirection$$1, flexWrap: flexWrap$$1, justifyContent: justifyContent$$1, alignItems: alignItems$$1, alignContent: alignContent$$1, theme: theme
  }, children);
};
...
FlexRow.defaultProps = {
  ...
  flexDirection: { xs: flexDirection.row },
  justifyContent: { xs: justifyContent.flexStart },
  alignItems: { xs: alignItems.stretch },
  alignContent: { xs: alignContent.stretch }
};

// $FlowIssues
var index$1 = wrapWithTheme(FlexRow);
